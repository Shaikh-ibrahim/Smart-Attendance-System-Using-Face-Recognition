...
<MenuScreen>:
    ...
    MDLabel:
        text : "-Developed By Ibrahim and Group-"
        font_style:'Caption'
...
class DemoApp(MDApp):
    ...
    def op(self):
        ...
        file_loc = "C:\\Users\\Ibrahim Shaikh\\PycharmProjects\\pythonProject3\\Main_Att.csv"
    ...
    def click(self, obj):
        ...
        # cv2.namedWindow("Pillai Smart Attendance System")
        img_c = 0
        while True:
            ...
            if key == ord("q"):
                ...
                cv2.imwrite("C:/Users/Ibrahim Shaikh/PycharmProjects/pythonProject3/ImagesBasic/" + img_res, frame)
                print("Running")
    ...
    def Attendance_Visualize(self):
        ...
        List_item = len(os.listdir("C:/Users/Ibrahim Shaikh/PycharmProjects/pythonProject3/ImagesBasic/"))
